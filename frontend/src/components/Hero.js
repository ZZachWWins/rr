...
function Hero() {
  return (
    <div className="hero glass-container text-center py-10 md:py-16" style={{ backgroundImage: `url(https://res.cloudinary.com/dbraufdni/image/upload/v1654321/GettyImages-941729686-1170x508_uro3a8)`, marginTop: "222px" }}>
